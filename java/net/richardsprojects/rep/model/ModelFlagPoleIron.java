...
public class ModelFlagPoleIron extends ModelBase
{
  //fields
    ModelRenderer pole;
    ModelRenderer base;
  ...
  public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
  {
    ...
    Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("rep:textures/blocks/FlagPoleIron.png"));
    pole.render(f5);
    base.render(f5);
    top2.render(f5);
    top1.render(f5);
