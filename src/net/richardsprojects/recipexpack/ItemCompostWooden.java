...
public class ItemCompostWooden extends Item {
   ...
   public ItemCompostWooden(int par1) {
      super(par1);
      this.maxStackSize = 1;
   ...
   public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
   {
	   ...
	   if(par3World.getBlockId(par4, par5, par6) == Block.crops.blockID)
	   {
		   ...
		   int bucketValue = 0;
			     ...
			     ItemStack replacementItemStack = new ItemStack(RecipeExpansionPack.bucketWoodEmpty);
			     
			     if(bucketValue == 5) {
			    	 replacementItemStack = new ItemStack(RecipeExpansionPack.bucketWoodCompost5);
			     }
			     else if(bucketValue == 4)
			     {
			    	 replacementItemStack = new ItemStack(RecipeExpansionPack.bucketWoodCompost4);
			     }
			     else if(bucketValue == 3)
			     {
			    	 replacementItemStack = new ItemStack(RecipeExpansionPack.bucketWoodCompost3);
			     }
			     else if(bucketValue == 2)
			     {
			    	 replacementItemStack = new ItemStack(RecipeExpansionPack.bucketWoodCompost2);
			     }
			     else if(bucketValue == 1)
			     {
			    	 replacementItemStack = new ItemStack(RecipeExpansionPack.bucketWoodCompost1);
			     }
